...
class Advogado(Funcionario):
    ...
    def __init__(self, nome: str, telefone: str, email: str, cpf: str, rg: str, dataNascimento: str, genero: Genero, matricula: str, setor: Setor, salario: float, endereco: Endereco, oab: str) -> None:
